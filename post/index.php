        ...
        <section class="article container-article">
            ...
            <div class="article-header">
                <div class="article-image">
                    ...
                    <img src="<?php echo DIRPAGE; ?>assets/img/post/<?php if (isset($article->imgname) && $article->imgname != null) {echo "$article->id_postagem/$article->id_postagem$article->imgtype";} else {echo "assets/img/logoHardTec.jpg";} ?>" alt="" height="629">
                </div>
